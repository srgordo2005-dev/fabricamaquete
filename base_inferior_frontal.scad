/* ==========================================================================
   PROJETO CAMPO TÁTIL - GABINETE INFERIOR (METADE FRONTAL DE IMPRESSÃO - 175x175mm)
   Contém o encaixe meia-madeira (Lap Joint) macho para união com a traseira
...
// RENDERIZA APENAS A METADE FRONTAL (Deslocada para o centro de impressão)
