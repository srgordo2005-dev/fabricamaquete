/* ==========================================================================
   PROJETO CAMPO TÁTIL - TAMPA SUPERIOR (METADE TRASEIRA "B" - 175x175mm)
...
// RENDERIZA A TAMPA TRASEIRA DESLOCADA PARA IMPRESSÃO (Y de 0 a 175mm com canal complementar)
