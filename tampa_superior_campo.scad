/* ==========================================================================
   PROJETO CAMPO TÁTIL - TAMPA SUPERIOR COMPLETA (LINHAS TÁTEIS A 0.3mm)
...
modo_peca = "completo"; // [frontal: Metade Frontal (Com degrau), traseira: Metade Traseira (Com rebaixo), completo: Tampa Completa (Apenas Visualização)]
...
// Execução do split inteligente da tampa
