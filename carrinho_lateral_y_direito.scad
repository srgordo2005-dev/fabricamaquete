/* ==========================================================================
   PROJETO CAMPO TÁTIL - CARRINHO LATERAL Y (METADE DIREITA DE IMPRESSÃO)
   Berço da cremalheira em U totalmente aberto para cima e para a esquerda (centro do campo)
   Pronto para fatiar direto na Bambu Lab A1 Mini (Suporte Zero)
   ========================================================================== */

$fn = 60;

module carrinho_lateral_y_direito() {
    ...
    difference() {
        ...
        // Canal de Encaixe em U Aberto por Cima E Aberto para a Esquerda (Centro do Campo)
        // Corta tudo a partir de X = -6.4mm em direção ao lado esquerdo (-X)
