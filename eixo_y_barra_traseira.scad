/* ==========================================================================
   PROJETO CAMPO TÁTIL - METADE TRASEIRA DO EIXO GUIA Y (IMPRESSÃO DIAGONAL)
...
module eixo_y_barra_traseira() {
    difference() {
        // Corpo da barra de Y = -10.0mm até Y = 172.5mm (Comprimento total: 182.5mm)
        translate([0, 81.25, 5])
            cube([10, 182.5, 10], center=true);
            
        // Corte da metade inferior da emenda (Z de 0 a 5.0mm na faixa Y de -10 a 10mm)
        translate([0, 0, 2.5])
